...
CREATE TABLE IF  NOT EXISTS admin_locations ( --Todo Убрать эту таблицу перенести поля в таблицу location добавить флаг локация администратора или пользователя поля кроме флага, lat и lon  могут быть нулл
id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
lat FLOAT,
lon FLOAT,
radius FLOAT,
